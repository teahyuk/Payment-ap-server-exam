...
public class SignController {
    ...
    public String signin(@ApiParam(value = "회원ID : 이메일", required = true) @RequestParam String id,
        ...
        UserEntity user = userRepository.findByUid(id).orElseThrow(SignInFailedException::new);
    ...
    public ResponseEntity<Boolean> signin(@ApiParam(value = "회원ID : 이메일", required = true) @RequestParam String id,
                               @ApiParam(value = "비밀번호", required = true) @RequestParam String password,
